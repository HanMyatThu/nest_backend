...
export class AddDeletedAt1718095252564 implements MigrationInterface {
    name = 'AddDeletedAt1718095252564'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "category" DROP COLUMN "registryDatesDeletedat"
        `);
        await queryRunner.query(`
